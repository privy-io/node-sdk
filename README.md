...
```sh
npm install git+ssh://git@github.com:stainless-sdks/privy-api-client-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npm install privy-api-client`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/privy-api-client-typescript/issues) with questions, bugs, or suggestions.
