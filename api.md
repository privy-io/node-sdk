...
- <code><a href="./src/resources/wallets.ts">WalletRawSignResponse</a></code>
...
- <code title="post /v1/wallets/{wallet_id}/raw_sign">client.wallets.<a href="./src/resources/wallets.ts">\_rawSign</a>(walletID, { ...params }) -> WalletRawSignResponse</code>
- <code title="post /v1/wallets/{wallet_id}/rpc">client.wallets.<a href="./src/resources/wallets.ts">\_rpc</a>(walletID, { ...params }) -> WalletRpcResponse</code>
- <code title="patch /v1/wallets/{wallet_id}">client.wallets.<a href="./src/resources/wallets.ts">\_update</a>(walletID, { ...params }) -> Wallet</code>
...
- <code title="get /v1/wallets/{wallet_id}">client.wallets.<a href="./src/resources/wallets.ts">get</a>(walletID) -> Wallet</code>
