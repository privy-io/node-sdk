...
import { Actions, ListActions } from './resources/actions';
import {
  Aggregation,
  AggregationGroupBy,
  AggregationInput,
...
import {
  ...
  WalletAutomationCreateParams,
  WalletAutomationExecutionListResponse,
  WalletAutomationExecutionResponse,
  WalletAutomationExecutionResponsesCursor,
  WalletAutomationExecutionStatus,
  WalletAutomationListExecutionsParams,
  WalletAutomationListParams,
  ...
  WalletAutomationResponsesCursor,
  WalletAutomationStatus,
  WalletAutomationSuccessResponse,
  WalletAutomationUpdateParams,
  WalletAutomations,
} from './resources/wallet-automations';
import {
  BlockInfo,
...
export declare namespace PrivyAPI {
  ...
  export { Actions as Actions, type ListActions as ListActions };
