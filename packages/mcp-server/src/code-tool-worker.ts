...
import { PrivyAPI, ClientOptions } from '@privy-io/node';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: PrivyAPI)`
    : `const run: (${functionSource.client}: PrivyAPI) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    'client.wallets._export',
    'client.wallets._initImport',
    'client.wallets._rawSign',
    'client.wallets._rpc',
    'client.wallets._submitImport',
    'client.wallets._update',
    'client.wallets.authenticateWithJwt',
    'client.wallets.create',
    'client.wallets.createWalletsWithRecovery',
    'client.wallets.get',
    'client.wallets.list',
    'client.wallets.transactions.get',
    'client.wallets.balance.get',
    'client.users._get',
    'client.users.create',
    'client.users.delete',
    'client.users.getByCustomAuthID',
    'client.users.getByDiscordUsername',
    'client.users.getByEmailAddress',
    'client.users.getByFarcasterID',
    ...
    'client.users.getByTelegramUsername',
    'client.users.getByTwitterSubject',
    'client.users.getByTwitterUsername',
    'client.users.getByWalletAddress',
    'client.users.list',
    'client.users.pregenerateWallets',
    'client.users.search',
    'client.users.setCustomMetadata',
    'client.users.unlinkLinkedAccount',
    'client.policies._createRule',
    'client.policies._delete',
    'client.policies._deleteRule',
    'client.policies._update',
    'client.policies._updateRule',
    'client.policies.create',
    'client.policies.get',
    'client.policies.getRule',
    'client.transactions.get',
    'client.keyQuorums._delete',
    'client.keyQuorums._update',
    'client.keyQuorums.create',
    'client.keyQuorums.get',
    'client.apps.get',
    'client.apps.allowlist.create',
    'client.apps.allowlist.delete',
    'client.apps.allowlist.list',
  ],
