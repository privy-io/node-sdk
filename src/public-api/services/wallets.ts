...
export class PrivyWalletsService extends Wallets {
  ...
  public batchCreate(body: PrivyWalletsService.BatchCreateInput): APIPromise<WalletBatchCreateResponse> {
    return this._client.post('/v1/wallets/batch', { body });
  }
  ...
  public async rpc(
    ...
    return await this._rpc(walletId, { ...rpcParams, ...headers });
  }
...
export namespace PrivyWalletsService {
  ...
  export type BatchCreateInput = WalletBatchCreateInput;
